...
df %>%
  st_make_valid() %>%
  filter(year %in% c(1993, 1998, 2002, 2007, 2012, 2018), 
         season == "Fall", 
...
#------------------------------------------------------------
## Focus on biomass overlap alpha
#------------------------------------------------------------
...
ggsave("Figures/biomass_overlap_fig.png")  
ggsave("Figures/biomass_overlap_fig.svg")  
